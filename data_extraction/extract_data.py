...
courses = pd.read_excel(filename, sheetname="Courses")
html_courses = convert_courses_to_table(courses)

references = pd.read_excel(filename, sheetname="References")
html_references = convert_references_to_table(references)

tools = pd.read_excel(filename, sheetname="Tools")
html_tools = convert_tools_to_table(tools)

videos = pd.read_excel(filename, sheetname="Videos")
html_videos = convert_videos_to_table(videos)

data = pd.read_excel(filename, sheetname="Data")
